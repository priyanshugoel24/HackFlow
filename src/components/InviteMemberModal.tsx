...
export default function InviteMemberModal({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-md p-6 space-y-6 rounded-lg bg-white shadow-md">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold text-gray-900">Invite a Team Member</DialogTitle>
